...
MessageManager = require "Framework.Updater.MessageManager"
NetworkMessageManager = require "Framework.Updater.NetworkMessageManager"
...
NetworkMessageManager:GetInstance()
